...
public class RequestHandler extends BaseController {
    ...
    public static Result handleFailureResponse(
        ...
        if("CLIENT_ERROR".equalsIgnoreCase(response.getResponseCode())) {
    ...
    public static Response prepareFailureMessage(Object exception, play.mvc.Http.Request req) {
        ...
        if (exception instanceof BaseException) {
            ...
            response.setResponseCode("CLIENT_ERROR");
            return response;
        }
        response.setResponseCode("SERVER_ERROR");
        response.put(JsonKey.MESSAGE, localizerObject.getMessage(IResponseMessage.INVALID_REQUESTED_DATA, null));
        return response;
    }
}